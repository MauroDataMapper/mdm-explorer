...
describe('ProfileService', () => {
  ...
  describe('get profile', () => {
    it('should get a profile for a data element', () => {
      ...
      endpointsStub.profile.profile.mockImplementationOnce((domainType, id, namespace, name) => {
      ...
      const actual$ = service.get(CatalogueItemDomainType.DataElement, '1', 'namespace', 'name');
  ...
  describe('searching', () => {
    ...
    it('should search within a catalogue item', () => {
      ...
      endpointsStub.profile.searchCatalogueItem.mockImplementationOnce((dt, i, pns, pn, q) => {
