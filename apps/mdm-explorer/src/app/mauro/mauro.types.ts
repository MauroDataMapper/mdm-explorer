...
export const isDataClass = (item: DataModel | DataClass | DataElement): item is DataClass =>
...
export const getKviValue = (items: KeyValueIdentifier[], key: string, defaultValue: string) => {
