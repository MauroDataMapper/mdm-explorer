...
import { BookmarkToggleComponent, TooltipHelpTextOption } from './bookmark-toggle.component';
...
describe('BookmarkToggleComponent', () => {
  ...
  it.each([true, false])('should emit a toggle event when initial state is %p', (initial) => {
