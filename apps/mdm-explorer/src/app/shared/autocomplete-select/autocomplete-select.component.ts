...
export const isAutocompleteSelectOption = (value: any): value is AutocompleteSelectOption => {
    ...
    MatFormFieldControl<AutocompleteSelectOption[]>
{
  ...
  get showMatchCount() {
    return this.displayMatchCount && this.searchCtrl.value && this.searchCtrl.value.length > 0;
  }

  get shouldLabelFloat() {
    return (
      this.focused || !this.empty || (!!this.searchCtrl.value && this.searchCtrl.value.length > 0)
    );
  }
