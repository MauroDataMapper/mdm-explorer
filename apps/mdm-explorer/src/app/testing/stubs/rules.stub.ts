...
export interface RulesServiceStub {
  list: jest.MockedFunction<(domainType: RuleDomainType, itemId: Uuid) => Observable<Rule[]>>;
  ...
  update: jest.MockedFunction<
    (domainType: RuleDomainType, itemId: Uuid, ruleId: Uuid, data: RulePayload) => Observable<Rule>
  >;
  ...
  listRepresentation: jest.MockedFunction<
    (domainType: RuleDomainType, itemId: Uuid, ruleId: Uuid) => Observable<RuleRepresentation[]>
  >;
