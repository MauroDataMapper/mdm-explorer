...
export type DataModelGetDataClassesFn = (parent: DataModel | DataClass) => Observable<DataClass[]>;
export type DataModelGetDataClassFn = (id: DataClassIdentifier) => Observable<DataClassDetail>;
export type DataModelGetDataElementsFn = (
  id: DataClassIdentifier
) => Observable<MdmIndexBody<DataElementDto>>;
export type DataModelGetDataElementFn = (id: DataClassIdentifier) => Observable<DataElementDetail>;
...
export type DataModelElementsForClassFn = (dataClass: DataClass) => Observable<DataElementDto[]>;
...
export type DataModelDataElementToBasicFn = (element: DataElementDto) => DataElementInstance;
...
export const createDataModelServiceStub = (): DataModelServiceStub => {
  return {
    getDataModelById: jest.fn() as jest.MockedFunction<(id: Uuid) => Observable<DataModelDetail>>,
    ...
    getDataElementsForDataClass: jest.fn() as jest.MockedFunction<DataModelElementsForClassFn>,
    ...
    elementsInAnotherModel: jest.fn() as jest.MockedFunction<DataModelElementsInAnotherModelFn>,
