...
import {
  ...
  StepName,
  StepResult,
} from '@maurodatamapper/mdm-explorer/app/data-explorer/specification-submission/type-declarations/submission.resource';
...
export interface FileGenerationStepServiceStub {
...
export const createFileGenerationStepServiceStub = (): FileGenerationStepServiceStub => {
  return {
