...
import { KnownRouterPath } from '@maurodatamapper/mdm-explorer/app/core/state-router.service';

export type StateRouterNavigateToFn = (fragments: any[], queryParams?: Params) => Promise<boolean>;
...
export const createStateRouterStub = (): StateRouterServiceStub => {
  return {
    ...
    navigateToKnownPath: jest.fn() as jest.MockedFunction<StateRouterNavigateToKnownPathFn>,
