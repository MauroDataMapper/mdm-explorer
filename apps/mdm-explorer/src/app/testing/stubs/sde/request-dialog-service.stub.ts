...
*/
import { RequestResponse, RequestUserRole } from '@maurodatamapper/sde-resources';
...
export interface RequestDialogServiceStub {
...
export const createRequestDialogServiceStub = (): RequestDialogServiceStub => {
  return {
