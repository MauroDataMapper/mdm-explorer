...
export type GetResearchUserByEmailMockedFn = jest.MockedFunction<GetResearchUserByEmailFn>;

export type SaveResearchUserFn = (user: ResearchUser) => Observable<ResearchUser | undefined>;
