...
export type GetOrganisationFn = (departmentId: Uuid) => Observable<UserOrganisationDTO>;
export type GetOrganisationMockedFn = jest.MockedFunction<GetOrganisationFn>;

export type GetUsersOrganisationFn = () => Observable<UserOrganisationDTO[]>;
export type GetUsersOrganisationMockedFn = jest.MockedFunction<GetUsersOrganisationFn>;

export interface SdeOrganisationServiceStub {
  get: GetOrganisationMockedFn;
  getUsersOrganisation: GetUsersOrganisationMockedFn;
}

export const createSdeOrganisationServiceStub = (): SdeOrganisationServiceStub => {
  return {
    get: jest.fn() as GetOrganisationMockedFn,
    getUsersOrganisation: jest.fn() as GetUsersOrganisationMockedFn,
  };
};
