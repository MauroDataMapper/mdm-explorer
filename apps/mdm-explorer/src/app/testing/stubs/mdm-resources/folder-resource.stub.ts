...
*/
import { ContainerCreatePayload, FolderDetailResponse, Uuid } from '@maurodatamapper/mdm-resources';
import { Observable } from 'rxjs';

export type MdmFolderSaveFn = (payload: ContainerCreatePayload) => Observable<FolderDetailResponse>;
