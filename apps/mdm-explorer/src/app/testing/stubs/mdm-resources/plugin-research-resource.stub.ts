...
*/
import { FolderDetail, MdmIndexResponse, MdmResponse, Uuid } from '@maurodatamapper/mdm-resources';
import { Observable } from 'rxjs';
import { KeyValueIdentifier } from '@maurodatamapper/mdm-explorer/app/mauro/mauro.types';
import {
  PluginResearchContactPayload,
  PluginResearchContactResponse,
} from '@maurodatamapper/mdm-explorer/app/mauro/plugins/plugin-research.resource';

export type PluginResearchContactFn = (
  data: PluginResearchContactPayload
) => Observable<PluginResearchContactResponse>;
export type PluginResearchSubmitDataSpecificationFn = (id: Uuid) => Observable<MdmResponse<any>>;
