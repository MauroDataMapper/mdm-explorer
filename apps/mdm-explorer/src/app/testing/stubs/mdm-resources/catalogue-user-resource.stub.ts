...
import { UserPreferences } from '@maurodatamapper/mdm-explorer/app/data-explorer/bookmark.service';
import {
  CatalogueUser,
...
export type CatalogueUserPreferencesMockedFn = jest.MockedFunction<CatalogueUserPreferencesFn>;
