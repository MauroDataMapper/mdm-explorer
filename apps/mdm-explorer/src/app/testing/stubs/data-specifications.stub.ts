...
import { DataSpecificationSourceTargetIntersections } from '@maurodatamapper/mdm-explorer/app/data-explorer/data-specification.service';
...
export type DataSpecificationGetDataSpecificationFolderFn = () => Observable<FolderDetail>;
...
export type DeleteDataSchemaFn = (dataSchema: DataClass) => Observable<DataElementOperationResult>;
export type DeleteDataClassFn = (dataClass: DataClass) => Observable<DataElementOperationResult>;
...
export interface DataSpecificationServiceStub {
  ...
  getQuery: jest.MockedFunction<
    (id: Uuid, type: DataSpecificationQueryType) => Observable<DataSpecificationQuery | undefined>
  >;
...
export const createDataSpecificationServiceStub = (): DataSpecificationServiceStub => {
  return {
    ...
    deleteDataElementMultiple: jest.fn() as jest.MockedFunction<DeleteDataElementMultipleFn>,
    ...
    deleteDataElementsFromQuery: jest.fn() as jest.MockedFunction<DeleteDataElementsFromQueryFn>,
