...
import { createMatDialogStub } from '@maurodatamapper/mdm-explorer/app/testing/stubs/mat-dialog.stub';
...
import { UserDetails } from '@maurodatamapper/mdm-explorer/app/security/user-details.service';
import {
  DataElementDto,
  DataElementInstance,
  DataSpecification,
} from '@maurodatamapper/mdm-explorer/app/data-explorer/data-explorer.types';
import { createBroadcastServiceStub } from '@maurodatamapper/mdm-explorer/app/testing/stubs/broadcast.stub';
...
describe('BrowseComponent', () => {
  ...
  describe('create data specification from data class', () => {
    ...
    it("should transition to data specification detail page if DataSpecificationCreatedAction is 'view-data-specification-detail'", () => {
      ...
      // assert
      expect(navigateToSpy).toHaveBeenCalledWith(['/dataSpecifications', dataSpecification.id]);
    });
