...
import { DataElementSearchResult } from '@maurodatamapper/mdm-explorer/app/data-explorer/data-explorer.types';
import {
...
export class DataElementComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.params
      ...
      .subscribe(([dataElementDetail, isBookmarked, profile, sourceTargetIntersections]) => {
  ...
  private setDataTypeModel() {
    ...
    this.terminologies.getModel(id, domainType).subscribe((model) => (this.dataTypeModel = model));
  }
