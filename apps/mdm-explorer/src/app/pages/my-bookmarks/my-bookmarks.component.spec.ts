...
describe('MyBookmarkComponent', () => {
  ...
  describe('on initialization', () => {
    ...
    it('should load intersections', () => {
      ...
      expect(harness.component.sourceTargetIntersections.dataSpecifications.length).toBe(2);
      expect(harness.component.sourceTargetIntersections.sourceTargetIntersections.length).toBe(2);
      ...
      expect(harness.component.sourceTargetIntersections.sourceTargetIntersections[0]).toBe(sti1);
      expect(harness.component.sourceTargetIntersections.sourceTargetIntersections[1]).toBe(sti2);
    });
  });
