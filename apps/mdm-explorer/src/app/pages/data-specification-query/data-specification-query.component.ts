  ...
  ngOnInit(): void {
    this.route.params
      .pipe(
        ...
        catchError(() => {
          return this.errorResponse('There was a problem finding your data specification.');
        }),
        ...
        catchError(() => {
          return this.errorResponse('There was a problem finding your data specification queries.');
        }),
        switchMap(([dataElements, query]) => {
          if (dataElements.length === 0) {
            this.stateRouter.navigateTo([this.backRouterLink, this.backRouterDataSpecificationId]);
            return EMPTY;
          }
