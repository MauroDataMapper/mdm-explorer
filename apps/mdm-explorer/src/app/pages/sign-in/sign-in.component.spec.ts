...
*/
import { FeaturesService } from '@maurodatamapper/mdm-explorer/app/core/features.service';
...
import {
  SignInClickEvent,
  SignInFormComponent,
} from '@maurodatamapper/mdm-explorer/app/security/sign-in-form/sign-in-form.component';
...
import { LoginError, SignInErrorType } from '@maurodatamapper/mdm-explorer/app/security/security.types';
import { HttpErrorResponse } from '@angular/common/http';
import { createStateRouterStub } from '@maurodatamapper/mdm-explorer/app/testing/stubs/state-router.stub';
import { createSdeAuthenticationEndpointsStub } from '@maurodatamapper/mdm-explorer/app/testing/stubs/sde/sde-authentication-endpoints.stub';
