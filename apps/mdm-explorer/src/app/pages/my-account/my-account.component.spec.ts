...
} from '@maurodatamapper/mdm-explorer/app/mauro/catalogue-user.service';
...
import { createCatalogueUserServiceStub } from '@maurodatamapper/mdm-explorer/app/testing/stubs/catalogue-user.stub';
