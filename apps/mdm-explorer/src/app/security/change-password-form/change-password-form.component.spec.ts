...
import { ChangePasswordPayload } from '@maurodatamapper/mdm-explorer/app/mauro/catalogue-user.service';
...
describe('ChangePasswordFormComponent', () => {
  ...
  it.each(fieldProperties)('should toggle %p from "hidden" to "visible" state', (prop) => {
    expectFieldInHiddenState(harness.component.fieldState[prop]);
    harness.component.toggleVisibility(prop);
    expectFieldInVisibleState(harness.component.fieldState[prop]);
  });

  it.each(fieldProperties)('should toggle %p from "visible" to "hidden" state', (prop) => {
    harness.component.toggleVisibility(prop);
    expectFieldInVisibleState(harness.component.fieldState[prop]);
    harness.component.toggleVisibility(prop);
    expectFieldInHiddenState(harness.component.fieldState[prop]);
