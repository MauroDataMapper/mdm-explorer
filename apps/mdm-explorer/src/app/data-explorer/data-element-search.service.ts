...
export class DataElementSearchService {
  ...
  private getPageParameters(params: DataElementSearchParameters): [number, PageParameters] {
    const page = params.page ?? 1;
    const pageParams = this.pagination.buildPageParameters(page, params.pageSize);
    return [page, pageParams];
  }

  private getCommonQueryParameters(params: DataElementSearchParameters): SearchQueryParameters {
    return {
      sort: params.sort,
      order: params.order,
