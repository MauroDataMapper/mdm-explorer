...
import { BookmarkDto, DataElementInstance, DataElementSearchResult } from './data-explorer.types';
...
describe('BookmarkService', () => {
  ...
  describe('index', () => {
    ...
    it('should return an empty array if there is no response body', () => {
      ...
      expect(actual$).toBeObservable(expected$);
      expect(endpointsStub.catalogueUser.userPreferences).toHaveBeenCalledWith(userDetails.id);
    });
