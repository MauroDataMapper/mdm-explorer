...
import { DataElementMultiSelectComponent } from '@maurodatamapper/mdm-explorer/app/shared/data-element-multi-select/data-element-multi-select.component';
...
describe('SearchFiltersComponent', () => {
  ...
  describe('behaviours', () => {
    ...
    it('should open the expanded dialog', () => {
      ...
      expect(spy).toHaveBeenCalledWith(SelectionExpandedDialogComponent, expect.anything());
    });
