...
import { createFileAttachmentStepServiceStub } from '@maurodatamapper/mdm-explorer/app/testing/stubs/data-specification-submission/file-attachment-step.service.stub';

describe('AttachPdfStep', () => {
  let step: AttachPdfStep;
  const fileAttachmentStepServiceStub = createFileAttachmentStepServiceStub();

  beforeEach(() => {
    // Default endpoint call
    step = setupTestModuleForService(AttachPdfStep, {
      providers: [
        {
