...
} from '@maurodatamapper/mdm-explorer/app/testing/stubs/mdm-endpoints.stub';
...
import { HeaderAndContentBoxComponent } from '@maurodatamapper/mdm-explorer/app/shared/header-and-content-box/header-and-content-box.component';
...
describe('DataElementSearchResultComponent', () => {
  ...
  it.each([true, false])('should emit a bookmark event when selected is %p', (selected) => {
    const emitSpy = jest.spyOn(harness.component.bookmark, 'emit');
    const item: DataElementSearchResult = {
      id: '1',
      label: 'test',
