...
export class VersionSelectorComponent implements OnInit, OnChanges {
  ...
  private setDropdownOptions() {
    this.dataModels.simpleModelVersionTree(this.modelId, false).subscribe((versionTree) => {
  ...
  private handleVersionTree(versionTree: SimpleModelVersionTree[]) {
    ...
    this.versionOptions = this.versionOptions.sort(this.versionSorter.compareVersionOptions());
  }
