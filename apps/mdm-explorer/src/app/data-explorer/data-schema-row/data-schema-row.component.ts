...
import { DataElementSearchResult, DataItemDeleteEvent, DataSchema } from '../data-explorer.types';
import { DataSpecificationSourceTargetIntersections } from '../data-specification.service';
import { DataSchemaService } from '@maurodatamapper/mdm-explorer/app/data-explorer/data-schema.service';
...
export class DataSchemaRowComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.dataSchema) {
      this.schemaElements = this.dataSchemaService.reduceDataElementsFromSchema(this.dataSchema);
    }
  }
