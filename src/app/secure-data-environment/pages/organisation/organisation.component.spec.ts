...
import { DepartmentMemberService } from '@maurodatamapper/sde-resources';
import { createDepartmentMemberServiceStub } from '../../../testing/stubs/sde/department-member.service.stub';
import { OrganisationComponent } from './organisation.component';

describe('DepartmentsComponent', () => {
  let harness: ComponentHarness<OrganisationComponent>;
  ...
  beforeEach(async () => {
    harness = await setupTestModuleForComponent(OrganisationComponent, {
      providers: [
        {
