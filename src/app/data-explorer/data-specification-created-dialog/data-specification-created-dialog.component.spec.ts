...
} from './data-specification-created-dialog.component';
import { MockDirective } from 'ng-mocks';

describe('DataSpecificationCreatedDialogComponent', () => {
  let harness: ComponentHarness<DataSpecificationCreatedDialogComponent>;
  const dialogRefStub = createMatDialogRefStub<DataSpecificationCreatedAction>();

  const dataSpecification = {
    label: 'test data specification',
  } as DataModel;

  const setupTestbed = async (data: DataSpecificationCreatedData) => {
    harness = await setupTestModuleForComponent(DataSpecificationCreatedDialogComponent, {
  ...
  it('should create', async () => {
    await setupTestbed({} as DataSpecificationCreatedData);
  ...
  it.each<DataSpecificationCreatedAction>(['view-data-specifications', 'continue'])(
