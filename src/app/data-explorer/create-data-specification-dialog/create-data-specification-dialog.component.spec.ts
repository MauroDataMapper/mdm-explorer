...
} from './create-data-specification-dialog.component';

describe('CreateDataSpecificationDialogComponent', () => {
  let harness: ComponentHarness<CreateDataSpecificationDialogComponent>;
  const dialogRefStub = createMatDialogRefStub<CreateDataSpecificationDialogResponse>();

  beforeEach(async () => {
    harness = await setupTestModuleForComponent(CreateDataSpecificationDialogComponent, {
      declarations: [
  ...
  it('should close when form is valid', () => {
    const expected: CreateDataSpecificationDialogResponse = {
